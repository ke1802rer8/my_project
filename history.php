...
<body>
            ...
            <div class="container__books">     
                ...
                <div class="headPage">
                    ...
                    <div class="headerCard">
                        ...
                        <span class="navigation__title" itemprop="name">История</a>
                    </div>
    ...
    <div class="modal">
            ...
            <button class="btn-reset modal__close">Закрыть</button>
                <div class="modal-content order-modal__content">
                    <div class="order-modal__top">
                        <div class="order-modal__title">Оформление заказа</div>
                    ...
                    <div class="order-modal__info">
                        ...
                        <div class="order-modal__summ order-modal__info-item">Общая сумма заказа: <span>1892</span></div>
                        <div class="order-modal__products order-modal__info-item">
                            <button class="order-modal__btn">
                                Состав заказа
                                <img src="img/arrow-down.jpg" class="order-down">
                            </button>  
                            <ul class="order-modal__list">
                                <!--<li class="order-modal__item" >
                                    <arcticle class="order-product__product order-product">
                                        <img src="img/Неночь_preview.jpg" alt="" class="order-product__img">
                                        <div class="order-product__text">
                                            <h3 class="order-product__title">Неночь </h3>
                                            <h3 class="order-product__author">Mona Kasten</h3>
                                            <span class="order-product__price">890 ₽</span>
                                        </div>
                    ...
                    <form action="#" class="order-modal__form order">
                        ...
                        <label  class="order__label">
                            ...
                            <input type="email" name="Email" class="order__input" placeholder="katya@mail.ru">
                        </label>
                        <label  class="order__label">
                        ...
                        <label  class="order__label">
                            <span class="order__text">Адрес</span>
                            <input type="text" name="Адрес" class="order__input">
                        </label>
                        <buttom class="order__btn product-card__button button_product btn"><span class="js__card_button_text">Оформить заказ</span></buttom>
                    </form>
                </div>
            </div>
        </div>
