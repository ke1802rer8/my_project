        ...
        <div class="product-card">
            ...
            <div class="product-card__footer">
                ...
                <button type="button" class="button js__product_card_button product-card__button button_product">
                    <span class="js__card_button_text">Добавить</span>
                </button>
            </div>
        </div>
    </div>
...
<head>
    ...
    <link rel="stylesheet" href="stylee.css">  <!--если проблема то замени на css/style.css-->
            ...
            <div class="container__books">     
                ...
                <div class="headPage">
                    ...
                    <div class="headerCard">
                        ...
                        <span class="navigation__title" itemprop="name">Книги</a>
                    </div>
                ...
                <div class="section--border">
                    ...
                    <div class="section--content">
                        ...
                        <div class="section--catalog">
                            ...
                            <form action="" method="post" class="grid__items" data-bb-id="<?=$post['id']?>">
                                <div class="img-product_block">
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card__footer">
                                        <div class="product-card__price">
                                            <span name="price_header" value="<?=$post['price']?>"class="product-price__value"><?=$post['price']?> ₽</span>
                                        </div>
                                            ...
                                            if($lo == 1):?>  
                                            <a href="pageblock.php" class="color_bottom_grey">
                                                <div  class="button color_bottom_grey js__product_card_button product-card__button button_product"  data-book-id="<?=$post['id']?>" >
